...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{pulse_chain.png}
    \caption{Un esquema de la cadena de electrónica de lectura usualmente utilizado para la lectura de un
