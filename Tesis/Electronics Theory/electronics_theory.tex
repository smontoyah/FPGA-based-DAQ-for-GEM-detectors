...
\noindent Es relevante destacar que el proceso de shaping también puede realizarse en la etapa de procesamiento digital, dependiendo de los requisitos específicos de la aplicación. Formas de pulso como las triangulares o trapezoidales, que son difíciles de obtener mediante electrónica analógica, pueden implementarse de manera más eficiente en el dominio digital \cite{radeka1968optimum}. En este contexto, estas formas se logran mediante la implementación de filtros FIR (Finite Impulse Response) con parámetros ajustados en plataformas configurables como las FPGA, un tema que se abordará con mayor detalle en la sección \ref{sec:digital_processing}.
